...
describe('Service Tests', () => {
    ...
    describe('BlogItem Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BlogItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/blog-items/' + 123);
            });
            it('should return BlogItem', () => {

                let entity: BlogItem;
                service.find(123).subscribe((_entity: BlogItem) => {
                    entity = _entity;
                });
