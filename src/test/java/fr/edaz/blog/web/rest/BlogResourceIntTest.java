...
public class BlogResourceIntTest {
    ...
    public void setup() {
        ...
        final BlogResource blogResource = new BlogResource(blogService, userService);
    ...
    public void createBlog() throws Exception {
        ...
        assertThat(testBlog.getSubtitle()).isEqualTo(DEFAULT_SUBTITLE);
    ...
    public void updateBlog() throws Exception {
        ...
        assertThat(testBlog.getSubtitle()).isEqualTo(UPDATED_SUBTITLE);
