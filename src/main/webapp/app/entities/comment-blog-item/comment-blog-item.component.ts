...
@Component({
    selector: 'jhi-comment-blog-item',
    templateUrl: './comment-blog-item.component.html'
})
export class CommentBlogItemComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.commentBlogItemService.search({
